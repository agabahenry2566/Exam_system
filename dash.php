...
$(function () {
    $(document).on( 'scroll', function(){
        ...
        {
             $(".navbar").addClass("navbarfixed-top");
        }
...
<div class="col-lg-6">
<span class="logo"> <img src="image/kyu.jpg" style="height:60px"/>Online Examination System</span></div>
<?php
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="dash.php?q=0"><b>BITC III</b></a>
    </div>
...
<tr style="color:red"><td><b>Rank</b></td><td><b>Name</b></td><td><b>Gender</b></td><td></td><td><b>Score</b></td></tr>';
$c=0;
...
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td><b>Delete</b></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
	$mob = $row['mob'];
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="time" name="time" placeholder="Enter time limit for exam in minutes" class="form-control input-md" min="1" type="number">
