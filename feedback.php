...
<div class="col-lg-6">
<a href="index.php"> <span class="logo" ><img src="image/kyu.jpg" style="height:60px"/>Online Examination System</span></a></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        ...
        <h4 class="modal-title title1"><span style="color:orange"><center>Log In</center></span></h4>
      </div>
  ...
  <div class="col-md-6">
    <input id="password" name="password" placeholder="Enter your Password" class="form-control input-md" type="password">
      ...
      <div class="modal-footer"><center>
        ...
        <button type="submit" class="btn btn-primary">Log in</button></center>
		</fieldset>
</form>
      </div>
    </div><!-- /.modal-content -->
...
<div class="col-md-10">
<a href="mailto:alindamarion@gmail.com" style="color:#000000">alindamarion@gmail.com</a><br /><br />
</div><div class="col-md-1"></div></div>
<p>Or you can directly submit your feedback by filling the entries below:-</p></center>
...
<div class="form-group"> 
<textarea rows="5" cols="8" name="feedback" class="form-control" placeholder="Write feedback here..." style="resize:none" required></textarea>
</div>
